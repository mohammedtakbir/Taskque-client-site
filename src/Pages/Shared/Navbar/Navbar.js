        ...
        <div className='bg-gray-50 dark:bg-gray-700'>
            <div className='max-w-[1200px] mx-auto py-3'>
                <nav className='md:container mx-auto flex justify-between items-center relative'>
                    <Link to='/' className='text-2xl font-medium dark:text-white'>TaskQue</Link>
                    <ul className={`md:bg-transparent bg-gray-200 rounded-lg md:flex items-center md:justify-end md:static absolute w-full text-center z-10 ${open ? 'top-12' : 'top-[-300px]'}`}>
                        ...
                        <li className='md:ml-8 md:mb-0 mb-4'>
                            <NavLink
